...
-- 6. CREATE SCHEMAS TABLE (Global Definitions)
--    Stores the field names for each log type to save bandwidth.
...
-- 7. SEED SCHEMAS
INSERT INTO log_schemas (log_type, fields) VALUES 
('API_LATENCY', ARRAY['api_call', 'status', 'status_code', 'error_message', 'signal_strength', 'connection_state', 'network_type']),
('GPS_ANOMALY', ARRAY['anomaly', 'description', 'jump_distance']);

-- 8. INSERT TEST DATA (Seed)
